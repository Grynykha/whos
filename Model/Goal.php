...
//  ----------------------------------------------------------------------------
    ...
    {   
        ...
        $stmt = $DB->prepare("SELECT COUNT(*) as count FROM game_goals WHERE id = :id");
...
//  ----------------------------------------------------------------------------
    ...
    {   
        ...
        $stmt = $DB->prepare("INSERT INTO game_goals(game_id, team_id, player_id, time, period, attributes, extra_attributes) 
