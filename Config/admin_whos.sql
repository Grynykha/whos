...
CREATE TABLE `players` (
  ...
  `curr_number` smallint(6) DEFAULT NULL,
  `curr_team_id` int(11) DEFAULT NULL,
  `nationality` int(11) DEFAULT NULL COMMENT 'region_id',
  `img_src` varchar(256) DEFAULT NULL,
  `born_date` datetime DEFAULT NULL,
  `born_region` int(11) DEFAULT NULL,
...
ALTER TABLE `a_games`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1250812;
...
ALTER TABLE `events`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24859;
...
ALTER TABLE `players`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=351718;

ALTER TABLE `players_description`
  MODIFY `content_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=351718;

ALTER TABLE `referee_description`
  MODIFY `content_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2918;

ALTER TABLE `regions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=255;

ALTER TABLE `regions_description`
  MODIFY `content_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=255;
...
ALTER TABLE `stages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15620;

ALTER TABLE `teams`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6149;

ALTER TABLE `teams_description`
  MODIFY `content_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6149;
