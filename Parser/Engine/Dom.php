...
use PRS\Parser\Engine\DomNode;
use PRS\Parser\Engine\Start;
...
class Dom
{
	...
	function createElement($name, $value=null) {return @Start::str_get_html("<$name>$value</$name>")->first_child();}
	function createTextNode($value) {return @end(Start::str_get_html($value)->nodes);}
